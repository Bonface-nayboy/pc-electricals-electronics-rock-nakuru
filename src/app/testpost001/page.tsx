...
const StarsFlowersContainer = styled('div')(({ theme }) => ({
    position: 'absolute',
    top: 0,
    left: '30%', // Default for larger screens
    ...
    [theme.breakpoints.down('sm')]: {
        left: '90%',  // Adjust for smaller screens
    ...
    return (
        ...
        >
            <Container
                sx={{
                    marginTop: '10px',
                    width: { xs: '100%', md: '30%' }, // Responsive width for xs and md screens
                    marginLeft: { xs: 'auto', md: '0px' },
                    padding: { xs: '0px 16px' }, // Add padding for better mobile view
                    position: 'relative',
                    zIndex: 1,
                }}
            >
                <Box display="flex" flexDirection="column">
                    {videos.map((video) => (
                        <Card key={video._id} sx={{ marginBottom: '10px', backgroundColor: 'rgba(255, 255, 255, 0.8)' }}>
                            {video.link ? (
                                <CardMedia
                                    component="iframe"
                                    src={getEmbedUrl(video.link)}
                                    title={video.title}
                                    sx={{ width: '100%', height: { xs: '300px', md: '250px' } }} // Responsive height
                                    allowFullScreen
                                />
                            ) : (
                                <CardMedia
...
//     position: 'absolute',
//     top: 0,
//     left: '70%', // Keep the stars and flowers on the right side
//     width: '30%',
//     height: '100%',
//     overflow: 'hidden',
//     zIndex: 1,
...
//                 sx={{
//                     marginTop: '10px',
//                     width: { xs: '90%', md: '30%' }, // Adjust width for xs screens to 90%
//                     marginLeft: { xs: 'auto', md: '0px' },
//                     padding: { xs: '0 16px' }, // Add padding for better mobile view
//                     position: 'relative',
//                     zIndex: 1,
//                 }}
//             >
...
//                                     src={getEmbedUrl(video.link)}
//                                     title={video.title}
//                                     sx={{ width: '100%', height: { xs: '150px', md: '250px' } }} // Reduce height for mobile
//                                     allowFullScreen
//                                 />
//                             ) : (
//                                 <CardMedia
